...
\begin{itemize}
    ...
    \begin{itemize}
        \item Explanation
        \begin{itemize}
            \item Creating input datasets for the program or making an input file based on four order types: sorted, nearly sorted, reversed and randomized and six sizes including 10000, 30000, 50000, 100000, 300000 ,500000.
    ...
    \begin{itemize}
        \item Explanation
        \begin{itemize}
            \item Adding two parameters: Comparisons and Time to sorting algorithms' implementations to calculate the number of comparisons and estimate the running time of the algorithm.
        \end{itemize}
        \item Pseudo code
        \begin{verbatim}
        \end{verbatim}
    ...
    \begin{itemize}
        \item Explanation
        \begin{itemize}
            \item Create a struct call Command to save the input parameters
            \item Base on the properties of the variable command, this function can identify the command to execute the program.
        \end{itemize}
        \item Pseudo code
        \begin{verbatim}
        \end{verbatim}
    ...
    \begin{itemize}
        \item Explanation
        \begin{itemize}
            \item Deal with output data and print the result to console
        \end{itemize}
        \item Pseudo code
        \begin{verbatim}
        \end{verbatim}
