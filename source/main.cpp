...
void runTest() {
    ...
    cmdLine[0] = "07.exe";
    std::vector<std::string> algorithm = {"shaker-sort"/*, "insertion-sort", "shell-sort", "bubble-sort", "heap-sort", "merge-sort", "quick-sort", "radix-sort", "counting-sort", "binary-insertion-sort", "shaker-sort", "flash-sort"*/};
